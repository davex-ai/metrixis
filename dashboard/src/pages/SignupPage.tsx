    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-muted font-body mt-1">Create an account</p>
        </div>

        {message ? (
          <div className="bg-panel border border-line rounded-lg p-6 text-center">
            <p className="text-sm text-paper font-body">{message}</p>
            <Link to="/login" className="text-signal text-sm hover:underline mt-4 inline-block">
              Back to sign in
            </Link>
          </div>
        ) : (
